...
namespace gazebo
{
    ...
    public:
        void Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
        {
            ...
            this->n = gazebo_ros::Node::Get(_sdf);
            // Start the ROS subscriber.
            const gazebo_ros::QoS & qos = this->n->get_qos();
            this->topic_name = _sdf->GetElement("topicName")->Get<std::string>();
            this->sub_fm = this->n->create_subscription<geometry_msgs::msg::Wrench>(this->topic_name,
                            qos.get_subscription_qos(this->topic_name, rclcpp::SystemDefaultsQoS()),
                            std::bind(&UavControlPlugin::update_fm, this, std::placeholders::_1));
}
        ...
        void update_fm(const geometry_msgs::msg::Wrench::SharedPtr msg)
        {
    ...
    private:
        ...
        rclcpp::Subscription<geometry_msgs::msg::Wrench>::SharedPtr sub_fm;
        gazebo_ros::Node::SharedPtr n;
