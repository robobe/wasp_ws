  ...
  sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->jointName = "tilt_joint";
  
  if (_sdf->HasElement("joint"))
  {
    this->dataPtr->jointName = _sdf->Get<std::string>("joint");
  }
  std::string jointName = this->dataPtr->jointName;
...
void GimbalSmall2dPlugin::Init()
{
  ...
  topic = std::string("~/") +
    this->dataPtr->model->GetName() + "/" + this->dataPtr->jointName + "_status";
...
/*
https://github.com/gazebosim/gazebo-classic/blob/gazebo11/Migration.md

gz topic -p /gazebo/default/iris_with_ardupilot/gimbal_small_2d::tilt_joint_cmd -m "data:'3.14'"
gz topic -p /gazebo/default/iris_with_ardupilot/gimbal_small_2d::tilt_joint_cmd -m "data:'0'"
gz topic -p /gazebo/default/iris_with_ardupilot/gimbal_small_2d::tilt_joint_cmd -m "data:'1.57'"
gz topic -e /gazebo/default/iris_with_ardupilot/gimbal_small_2d::tilt_joint_status
